...
export class CarService {
  ...
  getCars(
    ...
    try {
      ...
      return this.http
        .get<CarResponse>(`${this.API_URL}/all-cars`, { headers, params })
  ...
  filterCars(): Observable<CarResponse> {
    try {
      const headers = this.getHeaders();
      return this.http
        .post<CarResponse>(`${this.API_URL}/filter-cars`, {}, { headers })
        .pipe(catchError(this.handleError));
    } catch (e) {
      return throwError(() => e);
    }
  ...
  addCar(carData: Car): Observable<Car> {
    try {
      const headers = this.getHeaders();
      return this.http
        .post<Car>(`${this.API_URL}/add-car`, carData, { headers })
        .pipe(catchError(this.handleError));
    } catch (e) {
      return throwError(() => e);
    }
  ...
  deleteCar(id: string): Observable<any> {
    const headers = this.getHeaders();
    return this.http
      .delete(`${this.API_URL}/delete-car/${id}`, { headers })
      .pipe(catchError(this.handleError));
  }
}
